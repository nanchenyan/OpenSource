/* 中信1级行业分类成分 */
%macro DB_Wind_Sector_CiticsLv1(dsn=windconn,
																database=wind,
																uid=yscpb,
																pwd=yscpb123,
	...
	(		
			...
			(
				...
				From 
					...
					Inner Join tb_object_1022 a On substring(f3_1400,1,4)=substring(a.code,1,4)
				Where 
					a.code Like 'b1%'
					And a.levelnum='2'
					And F6_1400='1'
...
options symbolgen mlogic mprint; 
%mend DB_Wind_Sector_CiticsLv1;


/*
%DB_Wind_Sector_CiticsLv1(	dsn=windconn,
														database=wind,
														uid=yscpb,
														pwd=yscpb123,
														outset=_Sector_CiticsLv1,
